 ...
 */
package com.mycompany.pert5_50422921_4ia16.controller;

import com.mycompany.pert5_50422921_4ia16.model.ModelMahasiswa;
import com.mycompany.pert5_50422921_4ia16.repository.MahasiswaRepository;
...
public class MahasiswaController {
    ...
    private void tambahMahasiswa(Scanner scanner) {
        ...
        // Baca seluruh baris, lalu ubah ke Integer
        int semester = Integer.parseInt(scanner.nextLine()); 
        
        System.out.print("Masukkan IPK : ");
        // Baca seluruh baris, ganti koma jadi titik (jaga-jaga), lalu ubah ke Float
        String ipkInput = scanner.nextLine().replace(',', '.'); 
        float ipk = Float.parseFloat(ipkInput);
